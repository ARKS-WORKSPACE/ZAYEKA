...
import { Calendar, Clock, DollarSign, ArrowLeft, CheckCircle, Gift, Sparkles, User, Mail, Phone, Users, MessageSquare } from 'lucide-react';
...
export default function EventApplyPage({ event, onClose }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validateForm()) {
      // Generate a VIP Event Pass reference code
      ...
      <div className="apply-content-container">
        {!isSubmitted ? (
          <div className="apply-split-layout">
            ...
            <div className="apply-visual-column">
              ...
              <div className="visual-details-card glass-panel">
                ...
                <div className="inclusions-section">
                  <h4 className="inclusions-title">
                    <Sparkles size={14} className="inc-icon" />
            ...
            <div className="digital-pass-card">
              ...
              <div className="pass-footer">
                ...
                <div className="pass-qr-wrapper">
                  ...
                  <ZayekaQRCode
                    text={`${window.location.origin}${window.location.pathname}?receipt=event&ref=${passRef}&name=${encodeURIComponent(rsvpForm.name)}&email=${encodeURIComponent(rsvpForm.email)}&phone=${encodeURIComponent(rsvpForm.phone)}&eventId=${activeEvent.id}&eventTitle=${encodeURIComponent(activeEvent.title)}&eventDate=${encodeURIComponent(activeEvent.date)}&eventTime=${encodeURIComponent(activeEvent.time)}&price=${activeEvent.price}&guests=${rsvpForm.guests}&requirements=${encodeURIComponent(rsvpForm.requirements || '')}`}
                    size={160}
