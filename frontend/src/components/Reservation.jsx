...
import { Calendar as CalendarIcon, Clock, Users, ArrowRight, ArrowLeft, CheckCircle, MapPin, Receipt } from 'lucide-react';
...
const TABLES = [
  ...
  { id: 'T10', name: 'VIP Alcove #10', type: 'Private Booth', capacity: 4, status: 'available' },
  { id: 'T11', name: 'VIP Alcove #11', type: 'Private Booth', capacity: 4, status: 'available' },
  { id: 'T12', name: 'Garden Patio #12', type: 'Outdoor Terrace', capacity: 4, status: 'available' },
  { id: 'T13', name: 'Garden Patio #13', type: 'Outdoor Terrace', capacity: 4, status: 'available' },
  { id: 'T14', name: 'Garden Patio #14', type: 'Outdoor Terrace', capacity: 6, status: 'available' },
  { id: 'T15', name: 'Imperial Suite #15', type: 'VVIP Private Room', capacity: 8, status: 'available' }
];
      ...
      const syncBooking = async () => {
        try {
          ...
          if (res.ok) {
            ...
            throw new Error(errData.message || 'Server rejected the booking request');
          }
        } catch (err) {
          console.error('Failed to sync reservation with server:', err);
          alert('Failed to complete reservation: ' + err.message);
        }
      };
              ...
              <div className="selected-table-preview glass-panel">
                {bookingData.tableId ? (
                  <div className="preview-details">
                    <CheckCircle className="preview-icon" size={20} />
                    <span>
            ...
            <div className="wizard-step confirmation-step animate-fade-in-up text-center">
              ...
              <div className="digital-ticket-wrapper">
                ...
                <div className="ticket-footer">
                  ...
                  <ZayekaQRCode
                    text={`${window.location.origin}${window.location.pathname}?ref=${bookingRef}&type=reservation`}
                    size={160}
